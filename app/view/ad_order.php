    ...
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a class="active" href="#">Chi tiết</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row mt-3">
            <div class="col-12 col-lg-8 d-flex flex-column gap-3">
                ...
                <section class="bg-secondary-subtle border border-1 border-dark-subtle rounded-1">
                    <div class="container">
                        <div class="mb-1 fw-bold d-inline h4">Mã đơn hàng: <span class="text-primary">
                                <?= $order[0]['Id'] ?>
                            </span> </div>
                        ...
                        <tbody>
                            ...
                            foreach ($order as $sp):
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <?= number_format($sp['DonGia'] * $sp['SoLuong'], 0, ',', '.') ?> ₫
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    ...
                    <div class="container">
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="fw-bold text-body-secondary">
                                <?= number_format($order[0]['TongTien'], 0, ',', '.') ?> ₫
                            </span>
                        </div>
                    </div>
                </section>
                ...
                <section class="border border-1 border-dark-subtle rounded-1">
                    <div class="container">
                        ...
                        <div class="d-flex justify-content-between mt-1">
                            ...
                            <span class="fw-bold text-body-secondary">
                                <?= number_format($order[0]['PhiVanChuyen'] ?? 0, 0, ',', '.') ?> ₫
                            </span>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-8">
                                <a href="<?=APPURL?>ad_order/detail?idDh=<?=$order[0]['Id']?>&&tt=<?=$order[0]['TrangThai']?>" class="btn container-fluid btn-warning <?= ($order[0]['TrangThai'] != 'cho-xac-nhan' && $order[0]['TrangThai'] != 'dang-chuan-bi') ? 'disabled btn-outline-danger' : '' ?>"><?= ($order[0]['TrangThai'] == 'cho-xac-nhan') ? 'Xác nhận đã thanh toán' : (($order[0]['TrangThai'] == 'dang-chuan-bi') ? 'Xác nhận đã gửi hàng' :$order[0]['TrangThai']) ?></a>
                            </div>
                            <div class="col-4"><a href="<?= APPURL ?>ad_order/CancelOrder?IdDh=<?= $order[0]['Id'] ?>"
                                    class="btn container-fluid btn-secondary <?= ($order[0]['TrangThai'] == 'huy-don') ? 'disabled btn-outline-secondary' : '' ?>">Hủy
                                    Đơn </a></div>
                        </div>

                        <div>
                            <a href="<?= APPURL ?>ad_order/index"
                                class="container-fluid btn btn-primary my-3 fs-5">Đóng</a>
                        </div>
                    </div>
                </section>
            </div>
